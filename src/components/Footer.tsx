        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Empowering learners worldwide with comprehensive exam preparation and certification solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/exams" className="text-gray-400 hover:text-white">Exams</Link></li>
